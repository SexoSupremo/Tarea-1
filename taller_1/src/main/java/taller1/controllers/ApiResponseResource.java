...
import taller1.services.api.ApiResponseService;
import taller1.services.api.DaoService;
...
public class ApiResponseResource {
    ...
    private DaoService serviceConConstructor;

    public ApiResponseResource(DaoService instanciaService) {
